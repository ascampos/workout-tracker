...
export const workoutTemplates: Record<WorkoutDayKey, WorkoutTemplate> = {
  ...
  lower_a: {
    ...
    exercises: [
      ...
      { exercise_key: 'calf_raise_machine', exercise_name: 'Calf Raise Machine' },
      { exercise_key: 'standing_calf_raise', exercise_name: 'Standing Calf Raise' },
      { exercise_key: 'seated_calf_raise', exercise_name: 'Seated Calf Raise' },
      { exercise_key: 'leg_press_calf_raise', exercise_name: 'Leg Press Calf Raise' },
      { exercise_key: 'cable_crunches', exercise_name: 'Cable Crunches' },
    ],
  },
  upper_b: {
